...
namespace QuantConnect.ToolBox.AlphaVantageDownloader
{
    ...
    /// </summary>
    public class AlphaVantageWebSocketClientWrapper : WebSocketClientWrapper
    {
        ...
        public AlphaVantageWebSocketClientWrapper(string apiKey, ISymbolMapper symbolMapper, SecurityType securityType, Action<string> messageHandler)
        {
            _apiKey = apiKey;
