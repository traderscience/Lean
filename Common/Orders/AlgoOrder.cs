...
namespace QuantConnect.Orders
{
    ...
    public class AlgoOrder : Order
    {
        ...
        /// <summary>
        /// New Algo order constructor, based on a LimitBase Order
        /// </summary>
        /// <param name="symbol">Symbol asset we're seeking to trade</param>
        /// <param name="quantity">Quantity of the asset we're seeking to trade</param>
        /// <param name="time">Time the order was placed</param>
        /// <param name="limitPrice">Limit price for the base LimitOrder</param>
        /// <param name="tag">User defined data tag for this order</param>
        /// <param name="properties">The order properties for this order, which include the Algo parameters</param>
        public AlgoOrder(Symbol symbol, decimal quantity, decimal limitPrice, DateTime time, string tag = "", IOrderProperties properties = null, string ocaGroup = null, OrderIntent intent = OrderIntent.Unknown)
            : base(symbol, quantity, time, tag, properties)
        {
            ...
            if (string.IsNullOrEmpty(tag))
            {
                ...
                SetTag(Invariant($"Limit Price: {limitPrice:C}"));
            }
        }
        ...
        {
            var order = new LimitOrder(Symbol, Quantity, LimitPrice, Time, Tag, Properties, ParentOrder, OcaGroup, Intent);
            CopyTo(order);
            return order;
        }
    }
