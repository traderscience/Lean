...
namespace QuantConnect.ToolBox.AlphaVantageDownloader
{
    ...
    /// </summary>
    public class AlphaVantageSymbolMapper : ISymbolMapper
    {
        /// <summary>
        ...
        public string GetBrokerageSymbol(Symbol symbol)
        {
            ...
            switch (symbol.SecurityType)
            {
                ...
                default:
                    throw new Exception($"AlphaVantageSymbolMapper.GetBrokerageSymbol(): unsupported security type: {symbol.SecurityType}");
            }
        }
            ...
            DateTime expirationDate = new DateTime(), decimal strike = 0, OptionRight optionRight = OptionRight.Call)
        {
            ...
            switch (securityType)
            {
                ...
                default:
                    throw new Exception($"AlphaVantageSymbolMapper.GetLeanSymbol(): unsupported security type: {securityType}");
            }
        }
    }
}
