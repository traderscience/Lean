...
namespace QuantConnect.Indicators
{
    public class EntropyIndicator : IndicatorBase<TradeBar>
    {
        ...
        public EntropyIndicator(string name, int period, int kamaPeriod)
            : base(name)
        {
            // Initialize KAMA with desired period
            _kama = new KaufmanAdaptiveMovingAverage(name + "_KAMA", kamaPeriod);
        ...
        protected override decimal ComputeNextValue(TradeBar input)
        {
            ...
            if (!_kama.IsReady || !_priceWindow.IsReady)
