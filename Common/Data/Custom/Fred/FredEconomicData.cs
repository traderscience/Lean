...
namespace QuantConnect.Data.Custom.Fred
{
    ...
    /// </summary>
    public enum FredDataTransformation
    {
        /// <summary>
        ///     The rate of change
        /// </summary>
    ...
    public class FredEconomicData : BaseData
    {
        ...
        private readonly FredDataTransformation _dataTransformation;
        ...
        /// </summary>
        public FredEconomicData() : this(FredDataTransformation.Level)
        {
        }
        ...
        public FredEconomicData(FredDataTransformation dataTransformation)
        {
        ...
        public override SubscriptionDataSource GetSource(SubscriptionDataConfig config, DateTime date, bool isLiveMode)
        {
            ...
            if (_backtestingFirstTimeCallOrLiveMode)
            {
                ...
                subscription = GetFredSubscription(config, isLiveMode);
            }
            else
            {
        ...
        private static string GetStringForDataTransformation(FredDataTransformation dataTransformation)
        {
            var item = "level";
            switch (dataTransformation)
            {
                case FredDataTransformation.Roc:
                    item = "change";
                    break;
                case FredDataTransformation.AnnualyRoc:
                    item = "yr_change";
                    break;
                case FredDataTransformation.CompoundedAnnualRoc:
                    item = "c_annual_roc";
                    break;
                case FredDataTransformation.AnnualyCCRoc:
                    item = "cc_annual_roc";
                    break;
                case FredDataTransformation.CCRoc:
                    item = "cc_roc";
                    break;
                case FredDataTransformation.Level:
                    item = "level";
                    break;
                case FredDataTransformation.Ln:
                    item = "log";
                    break;
                case FredDataTransformation.Pc:
                    item = "percent_change";
                    break;
                case FredDataTransformation.AnnualyPc:
        ...
        private SubscriptionDataSource GetFredSubscription(SubscriptionDataConfig config, bool isLiveMode)
        {
            ...
            var byteKey = Encoding.ASCII.GetBytes($"{FredConfig.ApiKey}");
