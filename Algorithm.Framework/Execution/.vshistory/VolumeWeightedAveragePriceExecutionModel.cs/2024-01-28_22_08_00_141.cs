...
namespace QuantConnect.Algorithm.Framework.Execution
{
    ...
    public class VolumeWeightedAveragePriceExecutionModel : ExecutionModel
    {
        ...
        public VolumeWeightedAveragePriceExecutionModel(decimal MaxPct = .01m, bool extendedHours = false, Resolution? secResolution = null, decimal MinimumQty=100m, decimal LotSize=100m,  bool AllowMarketOnOpenOrders = true)
        {
        ...
        protected class SymbolData
        {
            ...
            public SymbolData(QCAlgorithm algorithm, QuantConnect.Securities.Security security, Resolution? secResolution)
            {
                ...
                try
                {
                    ...
                    var name = algorithm.CreateIndicatorName(security.Symbol, "VWAPEXEC", secResolution == null ? security.Resolution : secResolution);
