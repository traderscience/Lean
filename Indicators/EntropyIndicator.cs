...
{
    // Calculates entropy by calculating the variance of the price series
    // from the KAMA series
    public class EntropyIndicator : IndicatorBase<TradeBar>
    {
        ...
        private RollingWindow<IndicatorDataPoint> _entropyWindow;

        /// <summary>
        /// Values provides access to prior bar's entropy value
        /// </summary>
        public RollingWindow<IndicatorDataPoint> Values => _entropyWindow;
            ...
            : base(name)
        {
            ...
            // Rolling windows to store historical prices for variance calculation
            _priceWindow = new RollingWindow<decimal>(_period);
            _movingAvgWindow = new RollingWindow<decimal>(_period);
            // entropy results are saved her
            _entropyWindow = new RollingWindow<IndicatorDataPoint>(windowLen);
        }
        ...
        protected override decimal ComputeNextValue(TradeBar input)
        {
            ...
            _entropyWindow.Add(new IndicatorDataPoint(input.EndTime,entropy));
            return entropy;
        }
